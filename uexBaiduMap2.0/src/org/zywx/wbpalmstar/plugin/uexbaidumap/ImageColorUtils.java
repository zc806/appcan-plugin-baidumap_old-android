...
public class ImageColorUtils {
	 ...
	 * @return
	 */
	public static StateListDrawable bgColorDrawableSelector(int nomal,int focus){
		ColorDrawable nomalColor = new ColorDrawable(nomal);
		ColorDrawable focusColor = new ColorDrawable(focus);
		StateListDrawable selector = new StateListDrawable();
		selector.addState(new int[] { android.R.attr.state_pressed }, focusColor);
		selector.addState(new int[] { android.R.attr.state_selected }, focusColor);
		selector.addState(new int[] { android.R.attr.state_focused }, focusColor);
		selector.addState(new int[] {}, nomalColor);
		return selector;
	} 
	
	 /** 对TextView设置不同状态时其文字颜色。 */  
    public static ColorStateList createColorStateList(int normal, int focus) {  
        int[] colors = new int[] { focus, focus,focus,normal};  
